                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <form action="" method="POST">
                                <?php for($x=0 ; $x<sizeof($decodedData) ; $x++) { ?>
                                    ...
                                    <?php if($decodedData[$x]['state_name'] == 'SABAH') { ?>
                                        <?php for($y=0 ; $y<sizeof($decodedData[$x]['demography']['parliament']) ; $y++) { ?>
                                            <div class="row collapse collapse-<?= $x ?>">
                                                <div class="col-md-offset-1 col-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <u>Muslim Bumiputera Percentage (%)</u>
                                                            <div class="form-group">
                                                                <input class="form-control"
                                                                    type="number"
                                                                    step="0.01"
                                                                    name="<?= $decodedData[$x]['demography']['parliament'][$y]['parliament_code'] ?>-muslim-bumiputera"
                                                                    placeholder="Muslim Bumiputera Percentage (%)"
                                                                    value="<?= $decodedData[$x]['demography']['parliament'][$y]['race']['muslim_bumiputera'] ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <u>Non-Muslim Bumiputera Percentage (%)</u>
                                                                <input class="form-control"
                                                                    type="number"
                                                                    step="0.01"
                                                                    name="<?= $decodedData[$x]['demography']['parliament'][$y]['parliament_code'] ?>-non-muslim-bumiputera"
                                                                    placeholder="Non-Muslim Bumiputera Percentage (%)"
                                                                    value="<?= $decodedData[$x]['demography']['parliament'][$y]['race']['non_muslim_bumiputera'] ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    ...
                                                                    placeholder="Other Ethnic Percentage (%)"
...
if(isset($_POST['submit'])) {
    ...
    for($x=0 ; $x<sizeof($decodedData) ; $x++) {
        ...
        if($decodedData[$x]['state_name'] == 'SABAH') {
            for($y=0 ; $y<sizeof($decodedData[$x]['demography']['parliament']) ; $y++) {
                $decodedData[$x]['demography']['parliament'][$y]['race']['muslim_bumiputera'] = floatval($_POST[$decodedData[$x]['demography']['parliament'][$y]['parliament_code'] . '-muslim-bumiputera']);
                $decodedData[$x]['demography']['parliament'][$y]['race']['non_muslim_bumiputera'] = floatval($_POST[$decodedData[$x]['demography']['parliament'][$y]['parliament_code'] . '-non-muslim-bumiputera']);
